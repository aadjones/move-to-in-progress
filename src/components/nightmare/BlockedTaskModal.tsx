...
export const BlockedTaskModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black bg-opacity-70 p-4">
      <div className="bg-white rounded-lg shadow-2xl p-4 sm:p-6 max-w-md w-full">
        ...
        <div className="flex justify-end">
          <button
            onClick={onClose}
            className="px-3 sm:px-4 py-2 bg-gray-500 text-white text-xs sm:text-sm rounded hover:bg-gray-600 transition-colors"
          >
            Understood
          </button>
        </div>
